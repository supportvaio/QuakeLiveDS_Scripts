...
apt-get -y install apache2 python3 python-setuptools lib32gcc1 curl git nano samba build-essential python-dev unzip dos2unix mailutils wget lib32z1 lib32stdc++6 libc6 supervisor
clear
